                ...
                <div class="card-body">
                    <form action="{{ route('faq.update', $faq->id) }}" method="POST">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="text" class="form-control" placeholder="Masukkan Pertanyaan disini...." name="pertanyaan" value="{{ $faq->pertanyaan }}">
                        </div>
                        <div class="form-group mb-2">
                            <label for="">Jawaban <abbr title="" style="color: black">*</abbr> </label>
                            <textarea id="jawabanFAQ" class="form-control" placeholder="Masukkan Jawaban disini..." name="jawaban">{{$faq->jawaban}}</textarea> 
                        </div>
                </div>
