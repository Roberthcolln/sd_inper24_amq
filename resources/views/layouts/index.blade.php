      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            ...
            @else
            <img src="{{ asset('logo/'.$konf->logo_setting) }}" class="img-circle elevation-2" alt="SD Inpres 24 Ambon" style="width: 45px; height: 45px">
            @endif
          </div>
          <div class="info">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{route('iventaris.index')}}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Fasilitas</p>
                  </a>
                </li>
