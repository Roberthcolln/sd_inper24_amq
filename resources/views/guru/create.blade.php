                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('guru.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="text" class="form-control" placeholder="Masukkan nama disini...." name="nama_guru" value="{{ old('nama_guru') }}">
                        </div>
                        <div class="form-group mb-2">
                            ...
                            <select name="jabatan_guru" id="dropdown">
                                ...
                                <option>Guru Bidang Studi</option>
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="text" name="facebook_guru" class="form-control" value="{{ old('facebook_guru') }}">
                        </div>
                        <div class="form-group mb-2">
                            <label for="">Akun Instagram</label>
                            <input type="text" name="instagram_guru" class="form-control" value="{{ old('instagram_guru') }}">
                        </div>
                        <div class="form-group mb-2">
